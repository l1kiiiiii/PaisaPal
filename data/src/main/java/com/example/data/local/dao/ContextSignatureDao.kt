...
interface ContextSignatureDao {
    ...
    @Query("SELECT * FROM context_signatures")
    suspend fun getAllSignatures(): List<ContextSignatureEntity>

    @Query("SELECT * FROM context_signatures WHERE id = :id LIMIT 1")
    suspend fun getById(id: String): ContextSignatureEntity?
}
